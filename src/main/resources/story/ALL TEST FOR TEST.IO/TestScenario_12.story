...
Scenario: Verify VIVIDUS accessibility For Settings > Notifications
...
And I click on element located by `By.cssSelector(a[href='/testers/727140/notification_settings/edit'])`
